...
/**
 * Executes commands and supports undo functionality. Note: This requires registration with the DI
 * container, so create a Config file in your module that returns a bean of this class.
 */
public class CommandExecutor {
     ...
     */
    public <T extends CommandRequest, Q extends CommandResponse> Q execute(
            Command<T, Q> command, T request) {
    ...
    public void undoLast() {
        ...
        if (lastCommand != null) {
            try {
                ...
                System.err.println(
                        "Undo not supported for: " + lastCommand.getClass().getSimpleName());
            }
        } else {
