...
public class PaymentService {
    ...
    public PaymentService(OrderRepository orderRepository, TransactionRepository transactionRepository, WalletRepository walletRepository) {
    ...
    public void pay(UUID orderId, PaymentMethod paymentMethod) {
        ...
        switch (paymentMethod) {
            case PaymentMethod.WALLET:
                paymentStrategy = new WalletPaymentStrategy(commandExecutor, orderRepository, transactionRepository, walletRepository);
                break;
            case PaymentMethod.COD:
                paymentStrategy = new CODPaymentStrategy(commandExecutor, orderRepository, transactionRepository);
                break;
            default:
